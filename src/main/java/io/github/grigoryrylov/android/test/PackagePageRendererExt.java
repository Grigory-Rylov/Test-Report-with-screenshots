 ...
 */
public class PackagePageRendererExt extends PageRendererExt<PackageTestResultsExt> {
    public PackagePageRendererExt(ReportType reportType) {
        super(reportType);
    }
    ...
    private void renderClasses(SimpleHtmlWriter htmlWriter) throws IOException {
        ...
        for (ClassTestResultsExt testClass : getResults().getClasses()) {
            htmlWriter.startElement("tr");
