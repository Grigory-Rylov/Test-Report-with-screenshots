 ...
 */
package org.gradle.fork.util;

import org.gradle.fork.internal.UncheckedException;
...
public class GradleVersion implements Comparable<GradleVersion> {
    ...
    static {
        ...
        try {
            buildTime = new SimpleDateFormat("yyyyMMdd").parse("20180911");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        CURRENT = new GradleVersion("4.1", buildTime, "-");
    }
